...
namespace LmcUserOtp\Factory\Controller;
...
use LmcUserOtp\Controller\UserOtpController;

class UserOtpControllerFactory implements FactoryInterface
{
    public function __invoke(ContainerInterface $serviceManager, $requestedName, array $options = null)
    {
        ...
        $controller = new UserOtpController($redirectCallback);
